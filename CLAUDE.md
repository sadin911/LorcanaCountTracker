...
Please strictly follow the repository rules and guidelines defined in [AGENTS.md](file:///Users/sadin/Project/LorcanaCountTracker/AGENTS.md).

## Critical Deploy & Release Rule
- **Always update version & create a git tag on deploy**:
  1. Bump version in `package.json` and `src/constants/version.ts`.
